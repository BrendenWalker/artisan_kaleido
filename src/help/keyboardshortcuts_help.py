...
def content() -> str:
    ...
    tbl_KeyboardShortcuts.add_row(['LEFT,RIGHT',QApplication.translate('HelpDlg','Change roast event key focus (when Keyboard Shortcuts are ON)')])
    ...
    tbl_KeyboardShortcuts.add_row(['Y',QApplication.translate('HelpDlg','Shows/Hides Mini Event editor')])
    ...
    tbl_KeyboardShortcuts.add_row(['Q,W,E,R + <value>',QApplication.translate('HelpDlg','Quick Special Event Entry.  The keys q,w,e, and r correspond to special events 1,2,3 and 4. The new <value> is established using the ENTER/RETURN key. The last digit can be removed by using the backspace key.')])
    tbl_KeyboardShortcuts.add_row(['V +  <value>',QApplication.translate('HelpDlg','Quick PID SV Entry. The new <value> is established using the ENTER/RETURN key. The last digit can be removed by using the backspace key.')])
    ...
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','Click on Roast Title'),QApplication.translate('HelpDlg','Graph'),QApplication.translate('HelpDlg','Open Roast Properties'),'&#160;'])
    ...
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','Double click on Graph canvas'),QApplication.translate('HelpDlg','Graph'),QApplication.translate('HelpDlg','Auto zoom out to show min and max of temperature curves\nDouble click again to zoom in to original view'),'&#160;'])
    ...
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','OPTION File>> New>> <recent-roast> [Mac]\nALT File>> New>> <recent-roast> [Win]'),QApplication.translate('HelpDlg','Graph'),QApplication.translate('HelpDlg','Sets roast properties to <recent-roast> without starting a new roast'),'&#160;'])
    ...
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','⌘ click &#39;CONTROL&#39; Button [Mac]\nCTRL click &#39;CONTROL&#39; Button [Win]'),QApplication.translate('HelpDlg','Graph'),QApplication.translate('HelpDlg','Toggle PID'),QApplication.translate('HelpDlg','Device = <all others>, Control enabled in Expert mode: Config>> Device')])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','PLUS, MINUS'),QApplication.translate('HelpDlg','Graph'),QApplication.translate('HelpDlg','Increase or Decrease PID lookahead'),'&#160;'])
    ...
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','Click on a custom Event'),QApplication.translate('HelpDlg','Graph'),QApplication.translate('HelpDlg','Select a custom Event'),QApplication.translate('HelpDlg','Event time highlighted with vertical yellow line')])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','PLUS, MINUS'),QApplication.translate('HelpDlg','Graph when Event selected'),QApplication.translate('HelpDlg','Increase or Decrease Event value'),'&#160;'])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','BACKSPACE'),QApplication.translate('HelpDlg','Graph when Event selected'),QApplication.translate('HelpDlg','Delete the selected Event'),'&#160;'])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','ESC'),QApplication.translate('HelpDlg','Graph when Event selected'),QApplication.translate('HelpDlg','Deselect the custom Event'),'&#160;'])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','TAB'),QApplication.translate('HelpDlg','Graph when Sliders visible'),QApplication.translate('HelpDlg','Sequence slider select'),QApplication.translate('HelpDlg','Requires Keyboard Control enabled in Expert mode: Config>> Events>> Sliders\nKeyboard Shortcuts must be turned off (ENTER)')])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','UP,DOWN,RIGHT,LEFT'),QApplication.translate('HelpDlg','Graph when Sliders visible'),QApplication.translate('HelpDlg','Increment selected slider up or down by step amount'),QApplication.translate('HelpDlg','Requires Keyboard Control enabled in Expert mode: Config>> Events>> Sliders\nKeyboard Shortcuts must be turned off (ENTER)')])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','OPTION+UP, OPTION+DOWN [Mac]\nPAGEUP,PAGEDOWN [Win]'),QApplication.translate('HelpDlg','Graph when Sliders visible'),QApplication.translate('HelpDlg','Increment selected slider up or down by 10'),QApplication.translate('HelpDlg','Requires Keyboard Control enabled in Expert mode: Config>> Events>> Sliders\nKeyboard Shortcuts must be turned off (ENTER)')])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','HOME,END'),QApplication.translate('HelpDlg','Graph when Sliders visible'),QApplication.translate('HelpDlg','Set selected slider to minimum or maximum value'),QApplication.translate('HelpDlg','Requires Keyboard Control enabled in Expert mode: Config>> Events>> Sliders\nKeyboard Shortcuts must be disabled (ENTER)')])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','Click on timer'),QApplication.translate('HelpDlg','Simulator\n(Expert mode)'),QApplication.translate('HelpDlg','Toggle Pause/Continue Simulation'),QApplication.translate('HelpDlg','Simulator speed may be changed while paused (hold shift  (1x), OPTION/ALT (2x) or COMMAND/CTRL (4x) on restart).')])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','OPTION Tools>>Simulator [Mac]\nALT Tools>>Simulator [Win]'),QApplication.translate('HelpDlg','Graph/Simulator\n(Expert mode)'),QApplication.translate('HelpDlg','Start or change Simulator speed to 2x mode'),'&#160;'])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','⌘ Tools>>Simulator [Mac]\nCTRL Tools>>Simulator [Win]'),QApplication.translate('HelpDlg','Graph/Simulator\n(Expert mode)'),QApplication.translate('HelpDlg','Start or change Simulator speed to 4x mode'),'&#160;'])
    tbl_AddlShortcuts.add_row([QApplication.translate('HelpDlg','⌘+L [Mac]\nCTRL+L [Win]'),QApplication.translate('HelpDlg','Roast Properties Roast tab\n(Expert and Standard modes)'),QApplication.translate('HelpDlg','Open volume calculator'),'&#160;'])
    ...
    tbl_MenuShortcuts.add_row(['⌘+SHIFT+S [Mac]\nCTRL+SHIFT+S [Win]',QApplication.translate('HelpDlg','File'),QApplication.translate('HelpDlg','Save As...')])
    ...
    tbl_MenuShortcuts.add_row(['⌘+W [Mac]\nCTRL+F4 [Win]',QApplication.translate('HelpDlg','Roast\n(Expert and Standard modes)'),QApplication.translate('HelpDlg','Switch Profiles (Foreground<=>Background)')])
    tbl_MenuShortcuts.add_row(['⌘+D [Mac]\nCTRL+D [Win]',QApplication.translate('HelpDlg','Config\n(Expert mode)'),QApplication.translate('HelpDlg','Open Devices dialog')])
    tbl_MenuShortcuts.add_row(['⌘+U [Mac]\nCTRL+U [Win]',QApplication.translate('HelpDlg','Config\n(Expert mode)'),QApplication.translate('HelpDlg','Open Curves dialog')])
    tbl_MenuShortcuts.add_row(['⌘+E [Mac]\nCTRL+E [Win]',QApplication.translate('HelpDlg','Config\n(Expert and Standard modes)'),QApplication.translate('HelpDlg','Open Events dialog')])
    tbl_MenuShortcuts.add_row(['⌘+A [Mac]\nCTRL+A [Win]',QApplication.translate('HelpDlg','Config\n(Expert and Standard modes)'),QApplication.translate('HelpDlg','Open Alarms dialog')])
    tbl_MenuShortcuts.add_row(['⌘+SHIFT+A [Mac]\nCTRL+SHIFT+A [Win]',QApplication.translate('HelpDlg','Config\n(Expert and Standard modes)'),QApplication.translate('HelpDlg','Open Axes dialog')])
    tbl_MenuShortcuts.add_row(['⌘+K [Mac]\nCTRL+K [Win]',QApplication.translate('HelpDlg','Tools\n(Expert mode)'),QApplication.translate('HelpDlg','Analyzer Auto All')])
    tbl_MenuShortcuts.add_row(['⌘+OPTION+A [Mac]\nCTRL+ALT+K [Win]',QApplication.translate('HelpDlg','Tools\n(Expert mode)'),QApplication.translate('HelpDlg','Analyzer Clear Results')])
